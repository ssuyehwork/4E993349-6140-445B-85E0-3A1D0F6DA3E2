...
void HotkeyManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->hotkeyPressed((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HotkeyManager::*)(int )>(_a, &HotkeyManager::hotkeyPressed, 0))
            return;
    }
}
...
// SIGNAL 0
void HotkeyManager::hotkeyPressed(int _t1)
{
